    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_by', models.ForeignKey(blank=True, editable=False, to=settings.AUTH_USER_MODEL, null=True, verbose_name='Lastly updated by')),
            ],
            options={
                'ordering': ['created'],
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('forum', models.ForeignKey(verbose_name='Topic forum', to='forum.Forum')),
                ('poster', models.ForeignKey(verbose_name='Poster', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='post',
            name='topic',
            field=models.ForeignKey(verbose_name='Topic', to='conversation.Topic'),
