...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'forum_polls_topicpoll', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('topic', self.gf('django.db.models.fields.related.OneToOneField')(related_name=u'poll', unique=True, to=orm['forum_conversation.Topic'])),
        ...
        db.send_create_signal(u'forum_polls', ['TopicPoll'])

        # Adding model 'TopicPollOption'
        db.create_table(u'forum_polls_topicpolloption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'options', to=orm['forum_polls.TopicPoll'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'forum_polls', ['TopicPollOption'])

        # Adding model 'TopicPollVote'
        db.create_table(u'forum_polls_topicpollvote', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('poll_option', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'votes', to=orm['forum_polls.TopicPollOption'])),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'poll_votes', to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'forum_polls', ['TopicPollVote'])


    def backwards(self, orm):
        # Deleting model 'TopicPoll'
        db.delete_table(u'forum_polls_topicpoll')

        # Deleting model 'TopicPollOption'
        db.delete_table(u'forum_polls_topicpolloption')

        # Deleting model 'TopicPollVote'
        db.delete_table(u'forum_polls_topicpollvote')
