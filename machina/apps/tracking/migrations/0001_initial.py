...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'tracking_forumreadtrack', (
        ...
        db.send_create_signal(u'tracking', ['ForumReadTrack'])

        # Adding unique constraint on 'ForumReadTrack', fields ['user', 'forum']
        db.create_unique(u'tracking_forumreadtrack', ['user_id', 'forum_id'])

        # Adding model 'TopicReadTrack'
        db.create_table(u'tracking_topicreadtrack', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'tracking', ['TopicReadTrack'])

        # Adding unique constraint on 'TopicReadTrack', fields ['user', 'topic']
        db.create_unique(u'tracking_topicreadtrack', ['user_id', 'topic_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TopicReadTrack', fields ['user', 'topic']
        db.delete_unique(u'tracking_topicreadtrack', ['user_id', 'topic_id'])

        # Removing unique constraint on 'ForumReadTrack', fields ['user', 'forum']
        db.delete_unique(u'tracking_forumreadtrack', ['user_id', 'forum_id'])

        # Deleting model 'ForumReadTrack'
        db.delete_table(u'tracking_forumreadtrack')

        # Deleting model 'TopicReadTrack'
        db.delete_table(u'tracking_topicreadtrack')
