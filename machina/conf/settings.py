...
FORUM_PERMISSIONS_USER_SELECT_WIDGET_FUNC = getattr(
    settings, 'MACHINA_FORUM_PERMISSIONS_USER_SELECT_WIDGET_FUNC',
    'machina.apps.forum.admin.get_widget_for_select')
FORUM_PERMISSIONS_GROUP_SELECT_WIDGET_FUNC = getattr(
    settings, 'MACHINA_FORUM_PERMISSIONS_GROUP_SELECT_WIDGET_FUNC',
    'machina.apps.forum.admin.get_widget_for_select')
